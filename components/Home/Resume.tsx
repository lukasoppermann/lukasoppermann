  ...
  return (
    <section className={`${style} Grid`} role="main" aria-label="Resume">
      ...
      <div>
        ...
        <Headline style="5" role="group"><DateTime from="01.10.2021" to="now" toLabel="NOW" format="YYYY"/></Headline>
      ...
      <div>
        ...
        <Headline style="5" role="group"><DateTime from="01.09.2020" to="01.10.2021" format="YYYY"/></Headline>
      ...
      <div>
        ...
        <Headline style="5" role="group"><DateTime from="01.10.2017" to="01.09.2020" format="YYYY"/></Headline>
